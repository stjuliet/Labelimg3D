...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_ImageDisplay.setGeometry(QtCore.QRect(11, 11, 1111, 821))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.groupBox_AnnOption.setGeometry(QtCore.QRect(1130, 12, 461, 461))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(10, 73, 262, 21))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 99, 421, 86))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(10, 191, 421, 41))
        ...
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 45, 301, 23))
        ...
        self.spinBox_CurAnnNum.setMinimum(0)
        ...
        self.layoutWidget4.setGeometry(QtCore.QRect(157, 425, 295, 30))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.horizontalLayout_6 = QtWidgets.QHBoxLayout(self.layoutWidget4)
        self.horizontalLayout_6.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_6.setObjectName("horizontalLayout_6")
        self.pushButton_ClearAnnotations = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        self.pushButton_SaveTempAnnotation = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        self.pushButton_SaveAnnotations = QtWidgets.QPushButton(self.layoutWidget4)
        ...
        self.layoutWidget6.setGeometry(QtCore.QRect(10, 373, 421, 47))
        self.layoutWidget6.setObjectName("layoutWidget6")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget6)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.label_Bbox3DSize = QtWidgets.QLabel(self.layoutWidget6)
        ...
        self.label_Bbox3D_Length = QtWidgets.QLabel(self.layoutWidget6)
        self.label_Bbox3D_Length.setObjectName("label_Bbox3D_Length")
        self.horizontalLayout_5.addWidget(self.label_Bbox3D_Length)
        self.doubleSpinBox_Bbox3D_Length = QtWidgets.QDoubleSpinBox(self.layoutWidget6)
        ...
        self.label_Bbox3D_Width = QtWidgets.QLabel(self.layoutWidget6)
        self.label_Bbox3D_Width.setObjectName("label_Bbox3D_Width")
        self.horizontalLayout_5.addWidget(self.label_Bbox3D_Width)
        self.doubleSpinBox_Bbox3D_Width = QtWidgets.QDoubleSpinBox(self.layoutWidget6)
        ...
        self.label_Bbox3D_Height = QtWidgets.QLabel(self.layoutWidget6)
        self.label_Bbox3D_Height.setObjectName("label_Bbox3D_Height")
        self.horizontalLayout_5.addWidget(self.label_Bbox3D_Height)
        self.doubleSpinBox_Bbox3D_Height = QtWidgets.QDoubleSpinBox(self.layoutWidget6)
        ...
        self.doubleSpinBox_Bbox3D_Rot = QtWidgets.QDoubleSpinBox(self.layoutWidget7)
        ...
        self.pushButton_add_new_bbox2d.setGeometry(QtCore.QRect(320, 3, 111, 31))
        ...
        self.pushButton_update_new_bbox2d.setGeometry(QtCore.QRect(320, 65, 111, 31))
        ...
        self.pushButton_cancel_add_new_bbox2d.setGeometry(QtCore.QRect(320, 34, 111, 31))
        ...
        self.groupBox_VehSize.setGeometry(QtCore.QRect(1130, 476, 459, 151))
        ...
        self.groupBox_FileList.setGeometry(QtCore.QRect(1130, 628, 459, 201))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.listView_FileList.setGeometry(QtCore.QRect(10, 20, 441, 171))
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1599, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionpedes.setText(_translate("MainWindow", "pedestrian"))
